...
var CalendarLine = /*#__PURE__*/function (_PureComponent) {
  _inherits(CalendarLine, _PureComponent);

  var _super = _createSuper(CalendarLine);

  function CalendarLine() {
    _classCallCheck(this, CalendarLine);

    return _super.apply(this, arguments);
  }

  _createClass(CalendarLine, [{
    key: "render",
    value: function render() {
      var _this = this;

      // render each day of the week
      var list = [0, 1, 2, 3, 4, 5, 6].map(function (dayOfTheWeek) {
        return /*#__PURE__*/_react["default"].createElement(_CalendarCell["default"], Object.assign({}, _this.props, {
...
_defineProperty(CalendarLine, "propTypes", {
